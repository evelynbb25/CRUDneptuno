...
public class ClienteDao {
    ...
    public Boolean borrar(Integer id) {
        ...
        try {
            ...
            System.err.println("Error en el borrar: " + e.getMessage() + " " + stmt.toString());
        }
        return resultado;
    ...
    public Boolean actualizacion(Cliente cliente) {
        Boolean result = false;
        PreparedStatement stmt = null;
        if (conexion == null || cliente == null) {
            return false;
        ...
        try {
            ...
            System.err.println("Error en la actualizacion : " + ex.getMessage() + " Query " + stmt.toString());
        } finally {
            try {
                if (stmt != null) {
                    stmt.close();
