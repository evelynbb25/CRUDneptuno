...
public class ProbClientesDao {
    ...
    public static void main(String[] args) {
        ...
        while (fin) {
            ...
            System.out.println("--------------------------------------------------------");
            System.out.println("\t1. Buscar datos de los  clientes");
    ...
    //Existe el cliente
    public static Cliente ExistClioente(){ //ExisteCliente
        Cliente c = null;
        System.out.print("\nIndique el ID del cliente que desea buscar: ");
        c = clientes.leer(Integer.parseInt(sc.nextLine()));
        return c;
    }

    public static void BuscrCliente() {//BuscarCliente
        Cliente cliente = ExistClioente();
...
//agregamos el cliente de forma automatica
    private static void AgregarCliente() {
        Cliente c = new Cliente();
        //base de datos autoincrementada, no se ingresa de forma manual
...
//modificacion de los clientes
    private static void ModificacionCliente() {
        Cliente cliente = ExistClioente();
            ...
            try {
                ...
                switch (opcion) {
                    case 1:
                        ...
                        clientes.actualizacion(cliente);
                        if (clientes.actualizacion(cliente) == true) {
